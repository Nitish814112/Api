...
import {WiSunset,WiHumidity,WiNightCloudyWindy,WiDayWindy,WiDaySunny,WiDayCloudyWindy,WiRain } from "react-icons/wi";
...
const WeatherCard = ({ weatherReport }) => {
  ...
  useEffect(() => {
    if(weathermood){
      switch (weathermood) {
        case "Haze":setNewWeathermood(GiHeatHaze);
          
          break;
          case "Clear":setNewWeathermood(WiDaySunny);
          break;
          case "Clouds":setNewWeathermood(WiDayCloudyWindy);
          
          break;
          case "Rain":setNewWeathermood(WiRain);
  ...
  return (
    <>
      ...
      <h3 className="footer">Created by @RazTechnical</h3>
    </>
  );
};
